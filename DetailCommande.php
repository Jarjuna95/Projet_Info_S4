...
<body id="accueil2">
    ...
    <div class="cadre-tableau-admin" style="max-width:800px;">
        ...
        <div class="ligne-info">
            ...
            <div class="donnee" id="statut-affiche">
                <strong>
        ...
        <div class="ligne-info">
            ...
            <div class="donnee" id="livreur-affiche">
                <?php if ($livreur) {
        ...
        <select id="select-statut" class="champ"> 
        ...
        <select id="select-livreur" class="champ"> 
        ...
        <div id="message-commande"></div>

        <button class="boutton" onclick="enregistrerCommande(<?php echo $commandeId; ?>)">
